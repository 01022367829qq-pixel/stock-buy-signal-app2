...
with col1:
    with st.container():
        ...
        ticker1 = st.text_input("티커 입력", key="ticker1")
...
with col2:
    with st.container():
        ...
        ticker2 = st.text_input("티커 입력", key="ticker2")
...
with col3:
    with st.container():
        ...
        ticker3 = st.text_input("티커 입력", key="ticker3")
...
with col4:
    with st.container():
        ...
        ticker4 = st.text_input("티커 입력", key="ticker4")
...
with col5:
    with st.container():
        ...
        ticker5 = st.text_input("티커 입력", key="ticker5")
